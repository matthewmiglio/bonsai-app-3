      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-stone-100 p-6 rounded-lg">
            <div className="py-1"><Link href="/members" className="underline text-xl font-semibold mb-4 text-green-700">Community</Link></div>
          ...
          <div className="bg-stone-100 p-6 rounded-lg">
            <div className="py-1"><Link href="/calendar" className="underline text-xl font-semibold mb-4 text-green-700">Workshops & Events</Link></div>
            <p className="text-gray-700">
              We host regular workshops, meetups, and exhibitions to help members hone their skills and showcase their bonsai creations.
            </p>
          </div>
          <div className="bg-stone-100 p-6 rounded-lg">
            <div className="py-1"><Link href="/about" className="underline text-xl font-semibold mb-4 text-green-700">Passion for Bonsai</Link></div>
            <p className="text-gray-700">
